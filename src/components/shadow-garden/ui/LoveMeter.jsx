...
const LoveMeter = () => {
  ...
  return (
    <Container className="w-full max-w-md px-6 py-4 bg-black/40 backdrop-blur-md rounded-2xl border border-sg-pink/30 flex flex-col items-center">
      ...
      <BarContainer className="w-full h-6 bg-white/5 rounded-full overflow-hidden border border-white/10 relative">
        <Fill 
          $percent={loveMeter}
        ...
        {/* Floating Hearts inside bar */}
        <div className="absolute inset-0 flex items-center justify-around pointer-events-none opacity-40">
          <span>❤️</span><span>💖</span><span>💕</span>
        </div>
      </BarContainer>
      
      <p className="mt-2 font-dancing text-sg-pink text-sm italic">
        {loveMeter >= 100 ? "Ready for Domain Expansion!" : "Match symbols to fill the Heart Domain..."}
      </p>
